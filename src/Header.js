            ...
            <div>
              <nav className="space-y-8">
                <div className="grid gap-7 sm:grid-cols-2 sm:row-gap-8 sm:col-gap-4">
                  ...
                  <a
                    href="#"
                    className="-m-3 space-x-4 flex items-center p-3 rounded-lg hover:bg-gray-50 transition ease-in-out duration-150 mt-1 pt-1"
                  >
                    <div className="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-indigo-500 text-white sm:h-12 sm:w-12">
                      <svg
                        className="h-6 w-6"
          ...
          <div className="py-6 px-5 space-y-6">
            ...
            <span className="w-full flex rounded-md shadow-sm">
              ...
              <p className="text-center text-base leading-6 font-medium text-gray-500">
                ...
                <a
                  href="#"
                  className="ml-2 text-indigo-600 hover:text-indigo-500 transition ease-in-out duration-150"
                >
                  Sign in
                </a>
              </p>
